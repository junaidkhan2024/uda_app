...
ActiveRecord::Schema[8.1].define(version: 2026_08_07_154654) do
  ...
  create_table "chats", force: :cascade do |t|
    ...
    t.index ["session_key"], name: "index_chats_on_session_key"
  end
  ...
  create_table "knowledge_chunks", force: :cascade do |t|
    ...
    t.index ["source_type", "source_id"], name: "index_knowledge_chunks_on_source_type_and_source_id"
  end
